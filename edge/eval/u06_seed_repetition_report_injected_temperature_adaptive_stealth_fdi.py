...
scenario shape -- pure, additive, opt-in. Runs the four existing,
independently-committed U06 axis summaries (axis (i): ``edge.eval.
u06_rate_summary``; axis (ii): ``edge.eval.u06_tracker_agreement``; axis
(iii): ``edge.eval.u06_ground_truth_rate_summary``; channel-agreement: ``edge.eval.
u06_channel_agreement``) across the five
