...
u06_ground_truth_rate_summary``) across the five injected_humidity_bias_fdi
...
STILL PARTIAL COVERAGE OF SECTION D: with this module, 5 of the 9
evaluation-scenario shapes (clean degradation, injected_current_spike,
injected_temperature_drift, injected_pressure_stuck_at,
injected_humidity_bias_fdi) now have 5-seed coverage. Section D's proposed
