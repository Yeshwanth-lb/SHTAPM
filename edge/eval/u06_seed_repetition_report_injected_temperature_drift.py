...
§4 of the "U06 -- RL REWARD SHAPING SPECIFICATION PROPOSAL" section
...
STILL PARTIAL COVERAGE OF §4: with this module, 3 of the 9
evaluation-scenario shapes (clean degradation, injected_current_spike,
injected_temperature_drift) now have 5-seed coverage. §4's proposed
