...
## Status
- **P0 hardware-free: VERIFIED/COMPLETE** (offline stack + latency probe). **P1 hardware-free: COMPLETE** (C1–C4 + runtime). **P2 hardware-free FOUNDATIONS: COMPLETE (plumbing only)** — preprocess, injection framework, Beta core+engine, attribution shell, pipeline orchestrator, multivariate IF detector.
